    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                data.detail.forEach((err: { loc: string[]; msg: string; type: string })=> {
                    if (err.loc[1] === 'email') setEmailError(err.msg);
                    if (err.loc[1] === 'password') setPasswordError(err.msg);
                    });
    ...
    return(
        <View>
            <View style={styles.statement}>
                <Text style={styles.statementLine}>new to cash-pilot?</Text>
                <Text style={styles.statementLine}>sign in to get started</Text>
            </View>
